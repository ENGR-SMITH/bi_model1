        ...
        <div className="mt-4 grid gap-6 lg:grid-cols-[1fr_1fr] lg:items-stretch">
          ...
          <div className="flex items-center">
            <div className="tandem-room-hero w-full rounded-[1.5rem] border border-[#3b82f6]/40 bg-gradient-to-br from-[#3b82f6]/15 to-transparent p-6" data-testid="card-open-manuscript-studio">
              ...
              <a href="/authors-den/" className="focus-house mt-5 inline-flex items-center gap-3 rounded-full border border-white/20 bg-[#111111]/10 px-5 py-2.5 text-sm font-bold text-zinc-100 transition-colors hover:bg-[#111111]/20" data-testid="link-open-manuscript-studio">
                Open Authors Den
