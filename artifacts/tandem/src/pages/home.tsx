...
export default function Home() {
  return (
    <main className="tandem-public min-h-[100dvh] overflow-x-clip bg-[#0a0a0a]">
      ...
      <section id="rooms" className="mx-auto max-w-[1240px] px-5 py-20 sm:px-8 lg:px-10 lg:py-32">
        ...
        <div className="mt-14">
          <Link href="/room/engine" className="group block rounded-2xl border border-[#3b82f6]/30 bg-gradient-to-br from-[#3b82f6]/15 to-transparent p-7 transition-all hover:-translate-y-1 hover:border-[#3b82f6]/50 hover:shadow-[0_0_50px_-10px_rgba(59,130,246,0.3)] sm:p-10" data-testid="link-featured-engine">
            <div className="flex flex-col justify-between gap-10 sm:flex-row sm:items-end">
              <div>
                <div className="flex items-center gap-3 font-mono-ui text-[10px] uppercase tracking-[0.18em] text-[#60a5fa]"><span className="h-2 w-2 rounded-full bg-[#3b82f6] glow-dot" />First light / Foundation room</div>
              ...
              <span className="flex items-center gap-3 text-sm font-semibold text-white"><span className="flex h-12 w-12 items-center justify-center rounded-full border border-white/20 transition-transform group-hover:rotate-45"><ArrowUpRight className="h-5 w-5" /></span>Open the foundation</span>
            </div>
          </Link>
        </div>
