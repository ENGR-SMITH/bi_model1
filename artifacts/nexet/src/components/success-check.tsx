...
// Whop return gates the moment a charge is confirmed.
//
// Decorative only: the heading beside it ("Payment confirmed" / "PAYMENT
// CONFIRMED") already carries the meaning for screen readers, so the mark is
...
export function SuccessCheck({
  ...
  /** `sm` for the dens' compact receipt modals; `md` (84px) is the default. */
  size?: 'sm' | 'md';
  className?: string;
}) {
  return (
