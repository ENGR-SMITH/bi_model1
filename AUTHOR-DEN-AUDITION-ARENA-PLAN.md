...
- [ ] Watch endpoints + notify-on-publish fan-out with tests.
- [ ] `GET /arena/auditions/mine` + withdraw wrapper with tests.
- [ ] **Regression pass:** the existing collaboration test suite stays green.
